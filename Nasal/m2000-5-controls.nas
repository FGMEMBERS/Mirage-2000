## The goal is to overwrite some controls in order of put it on a stick (and even perhaps multiplex command on stick...)
#


######### First   Brakes #############
# Allow, on flight to put in the same button, the brakes and airbrakes, using
# defaults function, and put it on the joystick, and be able to accelerate and decelerate without put hand of the stick and search the keyboard.
##
# AirBrake handling.
#
